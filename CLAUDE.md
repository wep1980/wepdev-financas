...
| `docs/architecture/ollama-servidor-guia.md` | Como usar o Ollama compartilhado do servidor (GPU dedicada, ADR-0029) — API, timeouts, limites de concorrência, regras de segurança, pra este e outros sistemas |
