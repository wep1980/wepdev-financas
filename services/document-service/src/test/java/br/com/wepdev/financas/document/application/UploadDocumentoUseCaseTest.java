...
class UploadDocumentoUseCaseTest {
    ...
    void deveriaPersistirComoRecebido_eDespacharProcessamentoEmBackground() {
        ...
        UploadDocumentoCommand command = new UploadDocumentoCommand(
                usuarioId, TipoDocumento.FATURA_CARTAO, "fatura.pdf", "conteudo-pdf".getBytes(), "senha123", "WALDIR");
        ...
        verify(processador).processar(documento.getId(), usuarioId, command.conteudoArquivo(), "senha123", "WALDIR");
    }
