...
import br.com.wepdev.financas.document.infrastructure.client.dto.ContaDto;
 ...
 * publicar o evento de confirmação (ADR-0025). Ver PropagarAutorizacaoHeadersFactory.
 */
